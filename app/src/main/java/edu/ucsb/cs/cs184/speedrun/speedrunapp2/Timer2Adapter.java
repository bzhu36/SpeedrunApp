...
public class Timer2Adapter extends RecyclerView.Adapter<Timer2Adapter.gameViewHolder> {

    private LayoutInflater inflater;
    Game games[];
    Context context;

    public Timer2Adapter(Context context, GameList gameLists){
        if(context!=null) {
    ...
    class GameOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            ft.replace(R.id.content_main, SplitFrag.newInstance(games[position])).addToBackStack(null).commit();
        }
    }
}
