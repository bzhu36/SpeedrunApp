...
import edu.ucsb.cs.cs184.speedrun.speedrunapp2.game.run.Ruleset;
import edu.ucsb.cs.cs184.speedrun.speedrunapp2.user.ModeratorType;
...
public class Game {
    ...
    public static Game fromID(String id) throws IOException {
        Gson g = new Gson();
        URL u = new URL(Speedrun.API_ROOT + "games/" + id);
